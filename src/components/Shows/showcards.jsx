    ...
    <div className="showscontainer">
      <div className="showswrapper">
        {show.map((sh, index) => {
          return (
            <div>
              <div key={Math.floor(Math.random() * 1000000)} className="showcard">
                <div className="cardvisible">
                  <img src={Image1} alt="image_icon_tempo"></img>
                    ...
                    <div className="container-text">
                      ...
                      <div className="popup-show-cont">
                        ...
                        <div className="description-date">
                          <div className="description"><h5>Descripción</h5><p>{sh.description_show}</p></div>
                          ...
                          <div className="description">
                            <h5>Bandas invitadas</h5>
                            {
                              artists[index].map((artist) => {
                                return (
                                  <>
                                    <div key={Math.floor(Math.random() * 1000000)} className="date-hour">
